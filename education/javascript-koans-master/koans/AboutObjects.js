describe("About Objects", function () {
  ...
  it("should know properties that are functions act like methods", function () {
    ...
    expect(Array(4).join("1,")).toBe("1,1,1,")
  });
  ...
  describe("'in' keyword", function () {
    ...
    it("should not have the detonator however", function () {
      ...
      //true if object has property
      var hasMaster = "mastermind" in megalomaniac;
  ...
  it("should use prototype to add to all objects", function () {
    ...
    //dynamic override of parent function
    Circle.prototype.describe = function () {
      return "Overriden describe"
    };

    expect(simpleCircle.describe()).toBe("Overriden describe")
