...
class StartStop extends React.Component {
    ...
    render() {
        return <div className='start-stop-button'
        ...
        {/*<button className='start-stop-button'*/}
            ...
            {/*//####################### Stop button ############################*/}
            <div className="stop-btn" style={!this.state.isOn ? {display : 'none'} : {}}>
            <foreignObject className="stop-btn-active">
            ...
            {/*//####################### Stop button hover ############################*/}
            <foreignObject className="stop-btn-hover">
                <svg id='Layer_1' x='0px' y='0px'
                     width='110px' height='110px' viewBox='0 0 110 110' enableBackground='new 0 0 110 110'>
            ...
            <div className="start-btn" style={this.state.isOn ? {display : 'none'} : {}}>
            {/*//####################### Start button ############################*/}

            <foreignObject className="start-btn-active" >
                <svg id='Layer_1'
                     width='400px' height='400px' viewBox='0 0 374 374' enableBackground='new 0 0 374 374'>
            ...
            <foreignObject className="start-btn-hover">
                <svg x='0px' y='0px'
                     width='400px' height='400px' viewBox='0 0 374 374' enableBackground='new 0 0 374 374'>
