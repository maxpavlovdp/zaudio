...
var zeBoosterCore = {
    ...
    start: function () {
        ...
        this.animationID = window.setInterval(function () {
            ...
            zeBoosterCore.speedometr.setStatValue((v / 5).toFixed(1));
        }, 50);
    },
...
zeBoosterCore.speedometr = {};
zeBoosterCore.speedometr.init = function () {
    this.ticks = $('.tick');
    this.digits = $('.digit');
...
zeBoosterCore.speedometr.setStatValue = function (value) {
...
zeBoosterCore.speedometr.deg2rad = function (angle) {
    return angle * (Math.PI / 180);
};
zeBoosterCore.speedometr.rad2deg = function (angle) {
