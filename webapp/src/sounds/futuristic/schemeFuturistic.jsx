    ...
    main: [
        {
            ...
            pbr: {
                speed: [[0, 1], [20, 1.3], [120, 1.5], [240, 1.7]]
            },
            volume: {
                speed: [[0, 1], [120, 1.2], [160, 1.0], [200, 0.9]],
        ...
        },
        {
            ...
            pbr: {
                speed: [[5, 0], [30, 1.2], [50, 1], [100, 1.2], [160, 1.5], [200, 1.7]],
                power: [[0, 0], [290, 0.05], [581, 0.1]]
            },
            volume: {
                speed: [[5, 0], [30, 0.2], [50, 0.4], [200, 0.6]],
                power: [[0, 0], [290, 0.1], [581, 0.2]]
            },
            loop: true
        },
        {
            ...
            pbr: {
                speed: [[110, 0], [120, 0.5], [170, 1.0], [190, 1.2], [220, 1.5]],
                power: [[0, 0], [290, 0.05], [581, 0.1]]
            },
            volume: {
