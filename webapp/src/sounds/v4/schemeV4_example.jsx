let engineOnSampleV3 = require("../v3/engineOnSampleV3_fix.ogg"),
    engineOffSampleV3 = require("../v3/engineOffSampleV3_fix.ogg"),
    idlingLoopV3 = require("../v3/idlingLoopV3_fix.ogg"),
